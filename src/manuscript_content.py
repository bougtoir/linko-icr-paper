...
def build_english(res: dict) -> list:
    ...
    add(
        (
            ...
            "space. We formalise this structural feature within the LINKO (Latent Information "
            "Normalization for Key Outcomes) framework, whose core descriptor is the Information "
    ...
    add(
        (
            ...
            "not been formalised. This paper does three things. First, it introduces the LINKO "
            "(Latent Information Normalization for Key Outcomes) framework, in which the "
