...
Affiliation: Data Science and AI Innovation Research Promotion Center, Shiga University

Corresponding author: Tatsuki Onishi, [Address], [Email]

Word count of abstract: 243 (limit 250).
...
When IPD are available, principal component analysis (PCA) on the correlation matrix of the standardised variables (Jolliffe and Cadima 2016) gives two further estimators. The loading-based estimator sums the explained-variance ratios of components on which the endpoint has absolute loading at least 0.3:
...
- 4S Study Group: Randomised trial of cholesterol lowering in 4444 patients with coronary heart disease (4S). Lancet. 344, 1383–1389 (1994).
- ACCORD Study Group: Effects of intensive glucose lowering in type 2 diabetes. N Engl J Med. 358, 2545–2559 (2008).
...
- Downs, J. R., Clearfield, M., Weis, S.: Primary prevention of acute coronary events with lovastatin in men and women with average cholesterol levels (AFCAPS/TexCAPS). JAMA. 279, 1615–1622 (1998).
- Duckworth, W., Abraira, C., Moritz, T.: Glucose control and vascular complications in veterans with type 2 diabetes. N Engl J Med. 360, 129–139 (2009).
...
- Higgins, J. P. T., Thomas, J., Chandler, J.: Cochrane Handbook for Systematic Reviews of Interventions. Version 6.4. Wiley, Chichester (2023).
- International Stroke Trial Collaborative Group: The International Stroke Trial (IST). Lancet. 349, 1569–1581 (1997).
...
- LIPID Study Group: Prevention of cardiovascular events and death with pravastatin in patients with coronary heart disease. N Engl J Med. 339, 1349–1357 (1998).
- Morris, T. P., White, I. R., Crowther, M. J.: Using simulation studies to evaluate statistical methods. Stat Med. 38, 2074–2102 (2019).
- Paule, R. C., Mandel, J.: Consensus values and weighting factors. J Res Natl Bur Stand. 87, 377–385 (1982).
...
- Sacks, F. M., Pfeffer, M. A., Moye, L. A.: The effect of pravastatin on coronary events after myocardial infarction in patients with average cholesterol levels. N Engl J Med. 335, 1001–1009 (1996).
- Sandercock, P. A. G., Niewada, M., Czlonkowska, A.: The International Stroke Trial database. Trials. 12, 101 (2011).
- Schild, A. H. E., Voracek, M.: Less is less: a systematic review of graph use in meta-analyses. Res Synth Methods. 4, 209–219 (2013).
- Shepherd, J., Cobbe, S. M., Ford, I.: Prevention of coronary heart disease with pravastatin in men with hypercholesterolemia. N Engl J Med. 333, 1301–1307 (1995).
- Sterne, J. A. C., Sutton, A. J., Ioannidis, J. P. A.: Recommendations for examining and interpreting funnel plot asymmetry. BMJ. 343, d4002 (2011).
- Thompson, S. G., Higgins, J. P. T.: How should meta-regression analyses be undertaken and interpreted? Stat Med. 21, 1559–1573 (2002).
- UKPDS Study Group: Intensive blood-glucose control with sulphonylureas or insulin compared with conventional treatment (UKPDS 33). Lancet. 352, 837–853 (1998).
- Veroniki, A. A., Jackson, D., Viechtbauer, W.: Methods to estimate the between-study variance and its uncertainty in meta-analysis. Res Synth Methods. 7, 55–79 (2016).
